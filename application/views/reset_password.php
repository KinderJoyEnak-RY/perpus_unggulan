...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	...
	<div class="login-box">
		...
		<div class="login-box-body" style="border:2px solid #226bbf;">
			...
			<form action="<?= base_url('login/processReset'); ?>" method="POST">
				<div class="form-group has-feedback">
					<input type="password" class="form-control" placeholder="Password Baru" id="new_password" name="new_password" required="required" autocomplete="off">
					<span class="glyphicon glyphicon-key form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback">
					<input type="password" class="form-control" placeholder="Konfirmasi Password Baru" id="confirm_password" name="confirm_password" required="required" autocomplete="off">
					<span class="glyphicon glyphicon-key form-control-feedback"></span>
				</div>
				<input type="hidden" value="<?= $token ?>" name="token">
				<div class="row">
					<div class="col-xs-12">
						<button type="submit" id="loding" class="btn btn-primary btn-flat btn-block">Reset Password</button>
					</div>
				</div>
			</form>
		</div>
