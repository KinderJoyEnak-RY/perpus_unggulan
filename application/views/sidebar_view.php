	...
	<section class="sidebar">
        ...
        <?php if ($this->uri->uri_string() == 'user/edit/' . $this->uri->segment('3')) {
				...
				<?php if ($this->uri->uri_string() == 'data/bukudetail/' . $this->uri->segment('3')) {
						...
						<li class="<?php if ($this->uri->uri_string() == 'dashboard/scanqr') {
										echo 'active';
									} ?>
				<?php if ($this->uri->uri_string() == 'dashboard/scanqr' . $this->uri->segment('3')) {
							echo 'active';
						} ?>">
							<a href="<?php echo base_url("dashboard/scanqr"); ?>" class="cursor" target="_blank">
