...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	...
	<div class="login-box">
		...
		<div class="login-box-body" style="border:2px solid #226bbf;">
			...
			<form action="<?= base_url('login/processForgot'); ?>" method="POST">
				<div class="form-group has-feedback">
					<input type="text" class="form-control" placeholder="Nomor Telepon" id="telepon" name="telepon" required="required" autocomplete="off">
