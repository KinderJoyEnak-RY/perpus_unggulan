									...
									<table class="table table-striped">
										...
										<tr>
											...
											<td>
												...
												<?php } else { ?>
													<input type="text" class="form-control" readonly  name="anggota_id" value="<?php echo $this->session->userdata('anggota_id') ?>">
												<?php } ?>
											</td>
										</tr>
										<?php if ($this->session->userdata('level') == 'Petugas') { ?>
								...
								<div class="col-sm-7">
									<table class="table table-striped">
										...
										<tr>
											...
											<td>
												<div class="input-group">
													<input type="text" class="form-control" autocomplete="off" name="buku_id" id="buku-search" placeholder="Masukkan judul buku" type="text" value="">
													<span class="input-group-btn">
