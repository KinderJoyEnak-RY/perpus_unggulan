										...
										<tr>
											...
											<td style="text-align:center;">
												<?php if ($this->session->userdata('level') == 'Petugas') { ?>
													<?php if ($isi['tgl_kembali'] == '0' && $isi['status'] === 'Dipinjam') { ?>
													...
													<?php } elseif ($isi['tgl_kembali'] == '0' && $isi['status'] === 'Pending') { ?>
														<button onclick="approve('<?= $isi['pinjam_id']; ?>')" class="btn btn-success btn-sm" title="setujui peminjaman buku">
															<i class="fa fa-check"></i> Setujui</button>
													<?php } else { ?>
														<button class="btn btn-success btn-sm" disabled title="pengembalian buku">
