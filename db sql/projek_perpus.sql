...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jun 2023 pada 14.32
-- Versi server: 10.6.12-MariaDB-1:10.6.12+maria~ubu2204
-- Versi PHP: 7.4.33
...
INSERT INTO `tbl_absen` (`id`, `user_id`, `datetime`) VALUES
(7, 2, '2023-06-05 12:01:00');
...
(9, 'BK009', 2, 1, '0', '123-456-789', '0', 'MATEMATIKA DISKRIT', 'ERLANGGA', 'DWI NORMAWATI', '2020', '', 3, '2023-06-12 21:01:42');
...
CREATE TABLE `tbl_login` (
  ...
  `tgl_bergabung` varchar(255) DEFAULT NULL,
...
INSERT INTO `tbl_login` (`id_login`, `anggota_id`, `user`, `pass`, `level`, `nama`, `tempat_lahir`, `tgl_lahir`, `jenkel`, `alamat`, `telepon`, `email`, `tgl_bergabung`, `foto`, `reset_token`) VALUES
(1, 'AG001', 'anang', '202cb962ac59075b964b07152d234b70', 'Petugas', 'Anang', 'Bekasi', '1999-04-05', 'Laki-Laki', 'Ujung Harapan', '089618173609', 'fauzan1892@codekop.com', '2019-11-20', 'user_1567327491.png', NULL),
(2, 'AG002', 'fauzan', '202cb962ac59075b964b07152d234b70', 'Anggota', 'Fauzan', 'Bekasi', '1998-11-18', 'Laki-Laki', 'Bekasi Barat', '08123123185', 'fauzanfalah21@gmail.com', '2019-11-21', 'user_1589911243.png', NULL),
(4, 'AG003', 'noni', '202cb962ac59075b964b07152d234b70', 'Anggota', 'Noni', 'Bekasi', '1998-11-18', 'Laki-Laki', 'Bekasi Barat', '081804058981', 'fauzanfalah21@gmail.com', '2019-11-21', 'user_1589911243.png', '70fe2ac97fb65355b5a6471146a00660');
...
(11, 'PJ0011', 'AG003', 'BK008', 'Dipinjam', '2023-06-07', 3, '2023-06-10', '0');
